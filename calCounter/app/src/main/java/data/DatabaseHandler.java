...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    //Add content to db - add food items
    public void addFood(Food food){
        ...
        Log.v("Added food item", "YESSSSSSS");
        dba.close();
    ...
    public ArrayList<Food> getFoods(){
        ...
        Cursor cursor = dba.query(Constants.TABLE_NAME, new String[]{Constants.KEY_ID, Constants.FOOD_NAME,
                Constants.FOOD_CALORIES_NAME, Constants.DATE_NAME}, null, null, null, null, Constants.DATE_NAME + " DESC ");
