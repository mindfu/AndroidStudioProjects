...
import app.calcounter.com.calcounter.FoodItemDetailsActivity;
...
public class CustomListviewAdapter extends ArrayAdapter<Food>{
    ...
    public CustomListviewAdapter(@NonNull Activity act, @LayoutRes int resource, @IdRes ArrayList<Food> data) {
